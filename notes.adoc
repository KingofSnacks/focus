= Notes
:url-submittal: https://docs.google.com/forms/d/e/1FAIpQLSc6DQuFUS-MkJW1AS2IHQSH5e6ugdhs126QDKXuwY-19D7VRg/viewform
...
2+|*is the course listed in the catalog?*

|no
|Use the {url-submittal}[Course Submittal Form]

Then submit include::section-info.adoc[] to us at focus@parks.ca.gov 
