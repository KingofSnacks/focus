= Notes
:url-course-submittal:https://docs.google.com/forms/d/e/1FAIpQLSc6DQuFUS-MkJW1AS2IHQSH5e6ugdhs126QDKXuwY-19D7VRg/viewform
...
|no
|. Use the {url-course-submittal}[Course Submittal Form] attached and email it to us at focus@parks.ca.gov 
